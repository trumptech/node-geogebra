...
class GGBPool {
    ...
    ready() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            promises3 = new Array(this.opts.plotters);
            for (var i = 0; i < this.opts.plotters; i++) {
                promises3[i] = yield this.availablePages[i].evaluate('window.ggbApplet.setWidth(1280)');
                promises3[i] = yield this.availablePages[i].evaluate('window.ggbApplet.setHeight(850)');
                promises3[i] = yield this.availablePages[i].evaluate('window.ggbApplet.showAlgebraInput("bottom")');
                promises3[i] = yield this.availablePages[i].evaluate('window.ggbApplet.showMenuBar(true)');
            }
            yield Promise.all(promises3);
